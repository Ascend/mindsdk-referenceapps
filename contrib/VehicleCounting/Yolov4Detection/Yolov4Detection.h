...
#ifndef STREAM_PULL_SAMPLE_YOLOV4DETECTION_H
#define STREAM_PULL_SAMPLE_YOLOV4DETECTION_H
...
protected:
    ...
    void SetYolov4PostProcessConfig(const InitParam &initParam, std::map<std::string, std::string> &config);
private:
