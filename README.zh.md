...
[MindSDK](https://www.hiascend.com/software/mindx-sdk) 是华为推出的软件开发套件(SDK)，提供极简易用、高性能的API和工具，包含mxVision（视觉分析）、mxRAG（知识增强）、mxIndex（特征检索）、mxRec（搜索推荐）等多个SDK，助力昇腾AI处理器赋能各应用场景。
