...
本版本配套RAG SDK 7.1.RC1版本使用,依赖的其他配套软件版本为：

| 软件包简称                 | 配套版本    |
|-----------------------|---------|
| CANN软件包               | 8.2.RC1 |
| 二进制算子包Kernels         | 8.2.RC1 |
| npu-drive驱动包          | 25.2.0  |
| npu-firmware固件包       | 25.2.0  |
| Index SDK检索软件包        | 7.1.RC1 |
| MindIE推理引擎软件包         | 2.0.RC2 |
...
| 目录         | 说明                                                           |
|------------|--------------------------------------------------------------|
| Dockerfile | 部署RAG SDK容器,用户若自行准备镜像文件的参考样例，对应[《RAG SDK 用户指南》](https://www.hiascend.com/document/detail/zh/mindsdk/71rc1/rag/ragug/mxragug_0001.html)"安装部署/安装RAG SDK"章节。            |
