 ...
 * 算子：python3 vstar_generate_models.py --dim 256 --nlistL1 1024 --subDimL1 128
 * 码本：python3 vstar_train_codebook.py --dataPath {实际base数据路径} --dim 256 --codebookPath {实际码本输出路径}
 --nlistL1 1024 --subDimL1 128 --device 0
 */
