...
RAG SDK 详细资料参考 [昇腾社区](https://www.hiascend.com/software/mindx-sdk)
...
参考 RAG SDK环境安装手册，分别安装cann、rag SDK、以及部署embedding, reranker, mindie Service服务,安装langgraph包:pip3
