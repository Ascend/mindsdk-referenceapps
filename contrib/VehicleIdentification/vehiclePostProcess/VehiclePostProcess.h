 ...
 */
#ifndef VEHICLE_POST_PROCESS_H
#define VEHICLE_POST_PROCESS_H
#include "MxBase/PostProcessBases/ClassPostProcessBase.h"

namespace MxBase {
    class VehiclePostProcess : public ClassPostProcessBase {
    public:
        VehiclePostProcess() = default;

        ~VehiclePostProcess() = default;

        VehiclePostProcess(const VehiclePostProcess &other);
