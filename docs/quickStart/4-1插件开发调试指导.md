...
[点击跳转代码样例](https://gitee.com/ascend/mindsdk-referenceapps/tree/master/tutorials/mindx_sdk_plugin)
...
![image.png](img/1623406092822.png 'image.png')  
 ...
 ### 注意事项
 `mind_sdk_plugin/src/mxpi_sampleplugin/MxpiSamplePlugin.cpp`第141行起配置了pipeline中支持的props参数和默认值，如自行开发请按需求修改。
 ```c++
