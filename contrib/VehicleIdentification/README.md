...
### 1.1 简介
在本系统中，目的是基于VisionSDK，在昇腾平台上，开发端到端车型识别的参考设计，实现对图像中的车辆进行车型识别的功能，并把可视化结果保存到本地，达到功能要求。
...
将在3.1节获取到的googlenet模型压缩包解压，得到after-modify.caffemodel模型及其他文件存放至`./models/googlenet`。
