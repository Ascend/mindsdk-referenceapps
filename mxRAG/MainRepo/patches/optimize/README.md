...
| 目录       | 说明                                                                                              |
|----------|-------------------------------------------------------------------------------------------------|
| BertSelfAttentionFast     | 使用该性能优化补丁时需要编译算子及相应的torch_npu，并修改相应的transformers源文件，具体操作参考该目录下的使用说明。|
| transformers   | 针对transformers中的bert模型进行了相应的计算优化，执行该目录下的tei_patch.sh即可。|
...
| 目录       | 说明                                                                                              |
|----------|-------------------------------------------------------------------------------------------------|
| transformers    | 针对transformers中的xlm_roberta模型进行了相应的计算优化，执行该目录下的tei_patch.sh即可。|
