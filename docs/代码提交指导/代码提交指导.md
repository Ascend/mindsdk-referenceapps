...
**步骤一** fork主仓 Ascend / mindsdk-referenceapps 到个人分支

**步骤二** 使用 git 克隆自己的仓库到本地，命令如下：		

```
git clone https://gitee.com/xxxxxx/mindsdk-referenceapps.git
```

**步骤三** 将个人开发项目放在本地代码仓库相应目录下，参考设计代码目录为mindsdk-referenceapps/contrib/
...
- 修改路径【mindsdk-referenceapps/contrib/build_all.sh】中的buil_all.sh 文件，在sh文件20行SAMPLE_FOLDER中添加项目路径。
...
若门禁未触发或触发异常，可参见 [MindSDK常见问题FAQ-PR提交](https://gitee.com/ascend/mindsdk-referenceapps/blob/master/docs/MindSDK常见问题FAQ/MindSDK常见问题FAQ.md#6-pr提交) 部分
